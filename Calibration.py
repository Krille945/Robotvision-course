    ...
    while True:
        ...
        for i in range(0,len(avg_center_list_x[:])):
            ...
            if len(result_x)>=2:
                ...
                print('The first found brick had the following coordinates [x,y] in px:' + str([result_x[0],result_y[0]]))
                print('The second found brick had the following coordinates [x,y] in px:' + str([result_x[0],result_y[0]]))
                print('The first found brick had the following offset from [0,0] [x,y] in mm:' + str([result_x[0]*mm_pr_px,result_y[0]*mm_pr_px]))
                print('The second found brick had the following offset from [0,0] [x,y] in mm:' + str([result_x[0]*mm_pr_px,result_y[0]*mm_pr_px]))

                Found=True

            elif all(std<1 for std in std_list) and t>=100 and list_of_type[i]==type and len(p1x[i])>100:
                ...
                if new_result==True:
                    ...
                    result_x.append(avg_center_list_x[i])
                    result_y.append(avg_center_list_y[i])
                    result_angle.append(avg_angle)
